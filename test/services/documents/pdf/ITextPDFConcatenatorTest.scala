...
class ITextPDFConcatenatorTest extends PlaySpecification {
  ...
  "the concat method" should {
    "produce the correct number of pages when two documents are concatenated" in {
      val pdf1: Array[Byte] =
        IOUtils.toByteArray(getClass.getClassLoader.getResourceAsStream("forms/pdf_templates/VBA-21-0966-ARE.pdf"))
      val pdf2: Array[Byte] =
        IOUtils.toByteArray(getClass.getClassLoader.getResourceAsStream("forms/pdf_templates/VBA-21-526EZ-ARE.pdf"))
      ...
      val pdf1Reader: PdfReader =
        new PdfReader(getClass.getClassLoader.getResourceAsStream("forms/pdf_templates/VBA-21-0966-ARE.pdf"))
      val pdf2Reader: PdfReader =
        new PdfReader(getClass.getClassLoader.getResourceAsStream("forms/pdf_templates/VBA-21-526EZ-ARE.pdf"))
